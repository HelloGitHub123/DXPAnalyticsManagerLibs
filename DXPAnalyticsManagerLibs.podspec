...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/HelloGitHub123/DXPAnalyticsManagerLibs"
  ...
  spec.source       = { :git => "https://github.com/HelloGitHub123/DXPAnalyticsManagerLibs.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "DXPAnalyticsManagerLibs/**/*.{h,m}"
